"""
4.2 Edition of Mie-Scattering Simulation
Add another sphere on the side
...
#get the field for the 1st sphere (big)
a1 = 15
ps1 = [-25, 0, 15]
Et_1, Emask1, Ef = getTotalField(k, k_j, n0, res, a1, ps1, pp, numSample, NA_in, NA_out, option)
#get the field for the 2st sphere (small)
a2 = 15
ps2 = [25, 0, -15]
Et_2, Emask2, Ef = getTotalField(k, k_j, n0, res, a2, ps2, pp, numSample, NA_in, NA_out, option)
