...
def getTotalField(k, k_j, n, res, a, ps, pp, numSample, NA_in, NA_out, option):
    ...
    Etot, Bt, ordVec, Ef= MSI.scatterednInnerField(MSI.lambDa, MSI.magk, MSI.n, MSI.rMag)
...
pp = a0
ps0 = [0, 0, 0]
Et_0, B0 = getTotalField(k, k_j, n0, res, a0, ps0, pp, numSample, NA_in, NA_out, option)
...
#plt.colorbar()
#
#plt.suptitle('Field without BPF')
#
#plt.figure()
#plt.subplot(1, 3, 1)
