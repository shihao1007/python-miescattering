...
# get left sphere
E_left = shift_window(E_line, simRes, 'left', shift2, dimension=1)

# get right sphere
E_right = shift_window(E_line, simRes, 'right', shift2, dimension=1)
...
#    
#    # get right sphere
#    E_right = shift_window(E_line, simRes, 'right', shift, dimension=1)
#    
#    # merge two spheres
#    E_merge = E_left + E_right
#    
...
plt.subplot(141)
plt.plot(np.real(E_line))#, extent = [-simFov/2, simFov/2, -simFov/2, simFov/2])
plt.title('Complete Field, Real')
#plt.colorbar()

plt.subplot(142)
plt.plot(np.real(E_left))#, extent = [-simFov/2, simFov/2, -simFov/2, simFov/2])
plt.title('Left Sphere, Real')
#plt.colorbar()

plt.subplot(143)
plt.plot(np.real(E_right))#, extent = [-simFov/2, simFov/2, -simFov/2, simFov/2])
plt.title('Right Sphere, Real')
#plt.colorbar()

plt.subplot(144)
plt.plot(np.real(E_merge))#, extent = [-simFov/2, simFov/2, -simFov/2, simFov/2])
